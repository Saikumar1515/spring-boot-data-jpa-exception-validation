...
public class MyController {
	...
	public ResponseEntity<ResponseStructure<Student>> insert(@Valid @RequestBody Student student) {
		return service.insert(student);
	}

	// Save Multiple Records
	@PostMapping("/students/many")
	public ResponseEntity<ResponseStructure<List<Student>>> insert(@Valid @RequestBody List<@Valid Student> students) {
	...
	// Update One Record
	@PutMapping("/students")
	public ResponseEntity<ResponseStructure<Student>> update(@Valid @RequestBody Student student) {
		return service.update(student);
	}
	
	//Update Particular 
	@PatchMapping("/students/id/{id}")
	public ResponseEntity<ResponseStructure<Student>> update(@PathVariable int id, @Valid @RequestBody Student student) {
